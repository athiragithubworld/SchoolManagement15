...
const BirthdayCard = ({ image, message, name, designation }) => (
  <div className="flex flex-col w-[299px] shrink-0 sm:flex-row gap-2 justify-center items-center p-2 mt-2 text-base leading-5 text-black bg-white rounded-[14px] border border-solid shadow-primary  border-stone-300">
    <img
      src={image}
      alt="Birthday person"
