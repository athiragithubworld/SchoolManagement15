      ...
      <div className='w-full flex flex-col gap-5'>
        ...
        <div className='grid grid-cols-2 lg:grid-cols-3 gap-y-4 gap-x-4'>
          ...
          <div className='flex items-center gap-1'>
              ...
              readOnly={!editable}
              autoComplete='off'
              className="w-full h-12 border-[1px] shadow-md rounded-2xl p-2 text-center"
              name = "FatherName"
      ...
      <div className='w-full flex flex-col gap-4'>
          ...
          <div className='grid grid-cols-3 gap-y-4 gap-x-8'>
              ...
              <div className="flex gap-2 items-center">
                <label className="w-32 h-fit flex items-center font-medium text-left text-base">Pin Code</label>
                <input className="w-full h-12 border-[1px] shadow-md rounded-2xl p-2 text-center"
                  readOnly={!editable}
                  type="number"
                  onChange={changeHandler}
                  name = "CurrentPinCode"
              ...
              <div className="flex gap-2 items-center">
                <label className="w-32 h-fit flex items-center font-medium text-left text-base">City</label>
                <input className="w-full h-12 border-[1px] shadow-md rounded-2xl p-2 text-center"
                  readOnly={!editable}
                  type="text" 
                  onChange={changeHandler}
              ...
              <div className="flex gap-2 items-center">
                <label className="w-32 h-fit flex items-center font-medium text-left">State</label>
                <input className="w-full h-12 border-[1px] shadow-md rounded-2xl p-2 text-center"
                  readOnly={!editable}
                  type="text" 
                  onChange={changeHandler}
