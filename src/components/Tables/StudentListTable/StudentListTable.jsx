      ...
      <thead className=" pr-2">
        <tr className="w-full h-[74px] rounded-[14px] flex border-[1px] items-center justify-between bg-blue-100 p-3 shadow-md">
          <div className="flex w-56 justify-center items-center gap-[4px] cursor-pointer ">
            <th
              className={` h-fit text-sm lg:text-lg text-center font-bold`}
              onClick={() => {
          ...
          {/* <th className="w-56 h-fit text-sm lg:text-lg text-center font-bold">
            Student Name
          </th> */}
          ...
          {/* <th className="w-36 h-fit text-sm lg:text-lg text-center font-bold">
            Roll No
          </th> */}
          <div className="flex w-36 justify-center items-center gap-[4px] cursor-pointer ">
            <th
      ...
      <tbody className="flex flex-col gap-[10px] w-full overflow-y-scroll table-scrollbar h-tbodyheight py-1 pr-2">
        {sortedStudentListDetail.map((studentListDetail, index) => (
          ...
          >
            ...
            <td className="w-36 h-fit text-sm lg:text-lg text-center font-normal">
