...
function Notification({ status, message, showAlert, setShowAlert, key }) {
  ...
  return (
    <div
      className={`flex gap-10 items-center p-1 text-white ${
        ...
        ${showAlert ? "" : "hidden"}
       rounded-xl h-14 mt-[calc(100vh-10rem)] ml-[calc(100vw-45rem)] absolute`}
    >
